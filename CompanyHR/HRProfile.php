...
if($errorresult==false)
    ...
    $DOB = $_POST['DOB'];
    $Mobile = $_POST['Mobile'];
    $sql = "UPDATE hrinfo set HRFullName='$fname',Address='$Add',Mobile='$Mobile',Gender='$gen',DOB='$DOB' WHERE LoginId = $LoginId";
            ...
            <form action="" method="post">
                <div class="modal-body ">
                    <div class="row pr-3 pl-3">
                        ...
                        <input type="text" name="fname" value="<?php echo $res['HRFullName'] ?>" id="company" placeholder="Designation" class="form-control">
