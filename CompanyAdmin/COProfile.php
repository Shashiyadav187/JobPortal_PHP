...
if (isset($_POST['up'])) {
    ...
    $sql = "UPDATE companyinfo SET Address='$Address',ContactPersonName='$ContactPersonName',Mobile='$Mobile',CompanyEmail='$CompanyEmail',Wesite='$Wesite',AboutCompany='$AboutCompany' WHERE CompanyId= $LoginId";
    if (mysqli_query($conn, $sql)) {
            ...
            <form action="" method="post">
                <div class="modal-body ">
                    <div class="row pr-3 pl-3">
                        ...
                        <input type="text" name="ContactPersonName" value="<?php echo $res['ContactPersonName'] ?>" id="company" placeholder="Designation" class="form-control">
                        <span style="color: red;"><?php echo $error_name;?></span>
                    </div>

                    <div class="row pr-3 pl-3">
                        <label for="company" class=" form-control-label">CompanyEmail  :</label>
                        <input type="text" name="CompanyEmail" value="<?php echo $res['CompanyEmail'] ?>" id="company" placeholder="Designation" class="form-control">
                    ...
                    <div class="row pr-3 pl-3">
                        <label for="company" class=" form-control-label">Wesite:</label>
                        <input type="text" name="Wesite" value="<?php echo $res['Wesite'] ?>" id="company" placeholder="Designation" class="form-control">
                    ...
                    <div class="row pr-3 pl-3">
                        ...
                        <input type="text" name="AboutCompany" value="<?php echo $res['AboutCompany'] ?>" id="company" placeholder="Designation" class="form-control">
